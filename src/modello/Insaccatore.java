...
public class Insaccatore extends Panelista {
	...
	public Insaccatore(String email, String nome, String cognome, String luogoNascita, LocalDate dataNascita,
			String codiceFiscale, String residenza, double oreLavoro, int oreLimite,int limiteCanc) {
		super(email, nome, cognome, luogoNascita, dataNascita, codiceFiscale, residenza, oreLavoro);
		this.limiteCanc=0;
